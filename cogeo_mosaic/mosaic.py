...
class Mosaic:
    """Class for operations on Mosaic"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.mosaic_def = self.create_mosaic(
            features, minzoom, maxzoom, quadkey_zoom, **kwargs
        )
    ...
    def from_urls(
        ...
        **kwargs,
        ...
        return Mosaic(features, minzoom=minzoom, maxzoom=maxzoom, quiet=quiet, **kwargs)
    ...
    def create_mosaic(
        ...
        return MosaicJSON(**mosaic_definition)
